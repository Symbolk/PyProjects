...
def gen_exprs(project_bugid, oracle, expr_model_path, output_path, raw_expr_path, encoded_raw_expr, top, y_encoder):
    ...
    for r in row_num:
        ...
        varnames.append(raw_expr_values[r, 3])
...
def run_gen_exprs(params):
    ...
    classes, x_encoders, y_encoder = preprocess(data_file_path, 6, params['expr_frequency'])

    # get the predicted exprs
    gen_exprs(project_bugid, oracle, expr_model_path, output_path, raw_expr_path, encoded_raw_expr, top, y_encoder)
